...
- Describe the layering this project actually uses, and make it mandatory.

## Invariants — platform

- Record the runtime/toolchain versions this project requires.
- verify.sh is not configured yet. Fill in the real build/test commands before trusting any ✅.

## Prohibitions — code

- List the prohibitions that matter here (logging, secrets, unsafe casts).
